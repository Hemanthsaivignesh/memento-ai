...
class IntentDetector:
    ...
    INTENTS = {
        ...
        'coding': ['code', 'function', 'class', 'algorithm', 'implement', 'debug', 'fix', 'programming'],
    ...
    def detect_follow_up(cls, message: str) -> bool:
        ...
        follow_up_indicators = [
            ...
            'tell me more', 'why', 'how', 'explain', 'clarify'
        ]
        message_lower = message.lower()
    ...
    def detect_pronoun_references(cls, message: str) -> List[str]:
        ...
        pronouns = ['it', 'they', 'them', 'this', 'that', 'these', 'those', 'he', 'she', 'his', 'her']
        found = []
    ...
    def resolve_pronouns(self, message: str) -> str:
        ...
        for pronoun in pronouns:
            if pronoun in ['it', 'this', 'that']:
                ...
                if 'last_plural' in recent_entities:
